...
\facespeaks \vinphantom{You know: I showed the statute to you.} You did so.\\
...
\subtlespeaks \vinphantom{Pray God I have not stayed too long.} I fear it.\\
...
\direct*{\dol goes to the window}
\subtlespeaks \vinphantom{Now go prepare. Who's that?} It is not he?\\
\facespeaks O no, not yet this hour.\\
\subtlespeaks \vinphantom{O no, not yet this hour.} Who is it?\\
\dolspeaks \vinphantom{O no, not yet this hour. Who is it?} Dapper,\\
Your clerk.\\
...
\mammonspeaks \vinphantom{You are contented, sir?} Nay, in true being,\\
...
\direct*{Enter \kastril and \pliant outside. \kastril knocks and \subtle looks out of the window}
...
\subtlespeaks \vinphantom{With these the while?} Why, have them up and show them\\
