...
\direct*{Enter \face, \subtle and \dol stage left}
...
\dolspeaks \vinphantom{Since thou hast moved me---} O, this'll o'erthrow all.\\
...
\facespeaks \vinphantom{Your own destructions, gentlemen?} Still spewed out\\
...
\direct*{Dashes a vial out of \subtle's hand}
...
\direct*{\dapper enters stage right and knocks at the door}
...
Of my past-time.\\
\direct*{Enter \subtle stage left, dressed as the Alchemist}
...
Will take his oath on the Greek Testament,\\
...
\subtlespeaks \direct*{Aside to \face} \vinphantom{So may this gentleman too.} Why, sir---\\
...
I'll try.---\\
\direct*{To \subtle}
\vinphantom{I'll try.---} Say that it were for all games, doctor.\\
...
\facespeaks \vinphantom{You were born with a cawl on your head. Who says so?} Come,\\
...
\dapperspeaks \vinphantom{You'll send us shares in it, by this rate?} By Jove, sir,\\
...
\direct*{\drugger enters stage right and knocks at the door}
\subtlespeaks \vinphantom{``Captain, I'll see her grace.'' Enough.} Who's there?\\
Anon.\\
\direct*{Aside to \face}
\vinphantom{Anon.} ---Conduct him forth by the back way.---\\
\direct*{To \dapper}
...
\subtlespeaks \vinphantom{Yes, sir. A seller of tobacco? Yes, sir.} Umph!\\
Free of the grocers?\\
...
His house of life being Libra; which fore-shewed,\\
...
\vinphantom{Of drugs} ---This is the west, and this the south?\\
\druggerspeaks Yes, sir.\\
...
\druggerspeaks \direct*{Aside to \face} \vinphantom{Why, how now, Abel! is this true?} Good captain,\\
What must I give?\\
...
\facespeaks \vinphantom{Art thou well pleased, Nab? 'Thank, sir, both your worships.} Away.\\
\direct*{\face shuts the door, \drugger exits stage right}
...
\subtlespeaks \vinphantom{But I have spied sir Epicure Mammon---} Where?\\
...
\direct*{Exit \subtle and \dol}
\act

\scene

\direct*{Enter \mammon and \surly stage right}
...
\facespeaks \direct*{Calling from off stage left} Sir, he'll come to you by and by.\\
...
\direct*{Enter \face stage left, dressed as Lungs.}
...
\facespeaks \vinphantom{Thou art sure thou saw'st it blood?} Both blood and spirit, sir.\\
...
\facespeaks \direct*{Off stage left} Anon, sir.\\
\direct*{Enter \face stage left}
...
\surlyspeaks \direct*{Aside} \vinphantom{That work wants something.} O, I looked for this.\\
...
\subtlespeaks \vinphantom{And signed with Hermes' seal.} I think 'twas so.\\
We should have a new amalgama.\\
\surlyspeaks \direct*{Aside} \vinphantom{We should have a new amalgama.} O, this ferret\\
...
\surlyspeaks \direct*{Aside} \vinphantom{He says right.} Ay, are you bolted?\\
...
\mammonspeaks \vinphantom{We shall have a sallad!} When do you make projection?\\
...
\mammonspeaks \vinphantom{Wrapped in perplexed allegories?} I urged that,\\
And cleared to him, that Sisyphus was damned\\
To roll the ceaseless stone, only because\\
He would have made Ours common.\\
\direct*{Enter \dol stage left}
\vinphantom{He would have made Ours common.} ---Who is this?\\
...
He'll be mad too.---\\
\mammonspeaks \vinphantom{He'll be mad too.---} I warrant thee.--- Why sent hither?\\
\facespeaks Sir, to be cured.\\
\subtlespeaks \direct*{Off stage left} \vinphantom{Sir, to be cured.} Why, rascal!\\
...
Or so?\\
\subtlespeaks \direct*{Off stage left} \vinphantom{Or so?} Ulen!\\
...
Or the hot sulphur.\\
\direct*{Enter \face stage left}
\facespeaks \direct*{To \surly} \vinphantom{Or the hot sulphur.} Here's one from Captain Face, sir,\\
Desires you meet him in the Temple-church,\\
Some half-hour hence, and upon earnest business.\\
\direct*{Aside to \mammon}
...
\direct*{Exit \mammon stage right. Enter \subtle and \dol stage left}
...
\direct*{Exit \face}
\vinphantom{Stay, help me off, first, with my gown.} Away,\\
Madam, to your withdrawing chamber.\\
\direct*{Exit \dol}
\vinphantom{Madam, to your withdrawing chamber.} Now,\\
...
\direct*{\subtle opens the dooor to \ananias and calls off stage left}
Where is my drudge?\\
\direct*{Enter \face stage left}
...
\facespeaks \vinphantom{What's your ultimum supplicium auri?} Antimonium.\\
...
\direct*{\drugger enters stage right and knocks. \face goes to the window.}
...
\direct*{\face changes into the Captain out of \ananias' sight. He
...
Thou wicked Ananias!\\
\direct*{Exit \ananias stage right}
\vinphantom{Thou wicked Ananias!} This will fetch 'em,\\
...
\facespeaks Six of thy legs more will not do it, Nab.\\
He has brought you a pipe of tobacco, doctor.\\
\druggerspeaks \vinphantom{He has brought you a pipe of tobacco, doctor.} Yes, sir;\\
...
One glass of thy water, with a madam I know,\\
...
The doctor happily may persuade. Go to:\\
Shalt give his worship a new damask suit\\
Upon the premises.\\
\subtlespeaks \vinphantom{Upon the premises.} O, good captain!\\
\facespeaks \vinphantom{Upon the premises. O, good captain!} He shall;\\
...
\facespeaks \vinphantom{He'll send you a pound, doctor. O no.} He will do it.\\
It is the goodest soul!---Abel, about it.\\
Thou shalt know more anon. Away, be gone.\\
\direct*{Exit \drugger stage right}
...
\subtlespeaks \vinphantom{To get a medicine for them.} And shall, sir. This works.\\
...
\direct*{Exit \face stage right and \subtle stage left}
\act

\scene

\direct*{Enter \tribulation and \ananias stage right}
...
\ananiasspeaks \vinphantom{I think him a profane person indeed.} He bears\\
...
\direct*{\ananias knocks}
\vinphantom{And of the spirit; I will knock first.} Peace be within!\\
\scene

\direct*{\subtle enters stage left and opens the door}
...
\direct*{\subtle lets \tribulation and \ananias inside}
...
\direct*{\face enters stage right and knocks at the door}
...
\direct*{Exit \tribulation and \ananias stage left. \subtle looks through the window}
...
I know him of old.\\
\subtlespeaks \vinphantom{I know him of old.} O, but to have gulled him,\\
Had been a mastery.\\
...
\direct*{Enter \subtle stage left}
...
\facespeaks 'Slid, Nab shall do it against he have the widow,\\
...
\subtlespeaks \vinphantom{Till our new business be o'erpast.} But, Face,\\
...
No creature else.\\
\direct*{\dapper enters stage right and knocks}
\vinphantom {No creature else.} Who's that?\\
\direct*{\dol goes to the window}
...
\direct*{Enter \drugger and \kastril stage right. \face looks out of the window}
\vinphantom{It shall be brief enough.} 'Slight, here are more!\\
...
Not that I see. Away!\\
\direct*{Exit \subtle and \dol stage left. \face opens the door to \dapper}
...
\vinphantom{See her, and kiss her too.---} What, honest Nab!\\
...
\facespeaks \vinphantom{Do you not gull one?} God's my life! do you think it?\\
...
\kastrilspeaks \vinphantom{And be admired for it.} Will the doctor teach this?\\
...
\druggerspeaks \vinphantom{But once in his life!} Truth, and no more I was not.\\
...
\facespeaks \vinphantom{That lay so heavy on my stomach---} And he has no head\\
...
Thou took'st for being assessed at eighteen pence,\\
For the water-work.\\
\druggerspeaks \vinphantom{For the water-work.} In truth, and it was like\\
To have cost me almost my life.\\
\facespeaks \vinphantom{To have cost me almost my life.} Thy hair went off?\\
...
\direct*{Exit \kastril and \drugger}
\direct*{Aside}
\vinphantom{Drugger, she's thine: the damask!---} Subtle and I\\
Must wrestle for her.\\
\direct*{To Dapper}
\vinphantom{Must wrestle for her.} ---Come on, master Dapper,\\
...
\direct*{Enter \subtle, dressed as the Priest of Fairy}
...
\vinphantom{About his eyes,} to shew he is fortunate.\\
...
\direct*{\dapper throws away the contents of his pockets. \face and \subtle pick them up}
...
Bid Dol play music.---\\
\direct*{\subtle goes to the door stage left and \dol enters stage left playing bells}
\vinphantom{Bid Dol play music.---} Look, the elves are come.\\
To pinch you, if you tell not truth. Advise you.\\
\direct*{\face, \subtle and \dol pinch \dapper}
\dapperspeaks O! I have a paper with a spur-ryal in it.\\
\facespeaks \vinphantom{O! I have a paper with a spur-ryal in it.} Ti, ti.\\
They knew it, they say.\\
\subtlespeaks \vinphantom{They knew it, they say.} Ti, ti, ti, ti. He has more yet.\\
\facespeaks Ti, ti-ti-ti.\\
\direct*{Aside to \subtle}
\vinphantom{Ti, ti-ti-ti.} In the other pocket.\\
\subtlespeaks \vinphantom{Ti, ti-ti-ti. In the other pocket.} Titi, titi, titi, titi, titi.\\
...
and swears by the \emph{light} when he is blinded.\\
\dapperspeaks By this good \emph{dark}, I have nothing but a half-crown\\
...
\direct*{\mammon enters stage right and knocks. \dol looks through the window}
\vinphantom{You may wear your leaden heart still.---} How now!\\
...
With some device.\\
\vinphantom{With some device.} ---Ti, ti, ti, ti, ti, ti, Would her grace speak with me?\\
I come.---Help, Dol!\\
...
\direct*{Exit \subtle, \dol and \dapper stage left, \dol taking \face's Captain outfit}
\act
...
\facespeaks \direct*{Aside} \vinphantom{Shall do it better. Go.} Why, this is yet\\
...
\direct*{Enter \face stage left with \dol, dressed as the Lady}
\vinphantom{And mighty in my talk to her.---} Here she comes.\\
...
\facespeaks \direct*{Aside} \vinphantom{To all these princes.} I'll be sworn, I heard it.\\
...
\direct*{Exit \mammon and \dol stage left}
...
\direct*{\face lets \kastril and \pliant inside and exits stage left}
...
\kastrilspeaks \direct*{Aside} \vinphantom{And have your elements perfect.} What is this?\\
...
\direct*{Enter \face stage left, dressed as the Captain}
...
\direct*{\face kisses \pliant. \surly enters stage right, dressed as the
...
\facespeaks \direct*{Aside to \subtle} The count is come.\\
...
\direct*{To \kastril} Come, sir, the captain will come to us presently:\\
...
That hath the several scales upon it, shall make you\\
...
\direct*{Exit \subtle, \kastril and \pliant stage left}
\facespeaks Where are you, doctor?\\
\subtlespeaks \direct*{Off stage left} \vinphantom{Where are you, doctor?} I'll come to you presently.\\
...
Served in by a short cloke upon two trestles.\\
...
\subtlespeaks \vinphantom{I know no more but his action.} Yes, the casa,\\
...
\surlyspeaks \vinphantom{My worthy Donzel, cozened.} Entiendo.\\
...
My solemn Don?
\direct*{Aside to \subtle} \vinphantom{My solemn Don?} ---Dost thou feel any?\\
...
\direct*{Exit \face stage left}
\surlyspeaks \vinphantom{Dispatch, and call the brother too.} Tengo duda, senores,\\
...
\direct*{Exit \subtle and \surly stage left}
\scene

\direct*{Enter \face, \kastril and \pliant stage left}
...
\subtlespeaks \vinphantom{Barer to her, than at their prayers!} Is served\\
Upon the knee!\\
...
\kastrilspeaks \vinphantom{Nay, he will use her better.} Do you think so?\\
\surlyspeaks Senora, si sera servida, entremonos.\\
\direct*{Exit \surly and \pliant stage left}
...
\subtlespeaks \direct*{Aside to \face} Give Dol the word.\\
\direct*{Exit \face stage left}
...
\subtlespeaks \vinphantom{Her name is so, by her other husband.} How!\\
\kastrilspeaks The widow Pliant. Knew you not that?\\
\subtlespeaks \vinphantom{The widow Pliant. Knew you not that?} No, faith, sir;\\
...
\direct*{Exit \subtle and \kastril}
\scene

\direct*{Enter \dol and \mammon stage left}
...
\direct*{Enter \face, dressed as Lungs}
...
\subtlespeaks \direct*{Off stage left} \vinphantom{We are but faeces, ashes.} What's to do there?\\
\facespeaks O, we are lost! Now she hears him, she is quiet.\\
\direct*{Enter \subtle stage left. Exit \face and \dol stage left}
...
\direct*{There is an explosion off stage left}
\vinphantom{So the reward will prove.} ---How now! ah me!\\
God, and all saints be good to us.---\\
\direct*{Enter \face stage left}
\vinphantom{God, and all saints be good to us.---} What's that?\\
...
\direct*{\dol enters stage right and knocks at the door. \face looks
  out of the window. \dol exits stage right}
...
\mammonspeaks Will nought be saved that's good for medicine, think'st thou?\\
...
\direct*{Exit \face and \subtle stage left}
\scene

\direct*{Enter \surly and \pliant stage left}
...
\pliantspeaks \vinphantom{And whether I have deserved you or no.} I will, sir.\\
...
\direct*{\surly knocks \subtle down}
...
\direct*{Exit \face stage left}
\vinphantom{Then swoons his worship.} Or, he is the Faustus,\\
...
\direct*{\subtle tries to leave but \surly stops him}
\vinphantom{With the green sickness.} ---Nay, sir, you must tarry,\\
Though he be scaped; and answer by the ears, sir.\\
\direct*{Enter \face stage left with \kastril}
...
\direct*{Aside}
\vinphantom{The Spanish count will come here.} ---Bear up, Subtle.\\
\subtlespeaks Yes, sir, he must appear within this hour.\\
\direct*{\pliant talks to \kastril aside}
...
\kastrilspeaks \vinphantom{To trouble our art, though he could not hurt it!} Ay,\\
I know---\\
\direct*{To \pliant}
\vinphantom{I know---} Away, you talk like a foolish mauther.\\
\direct*{Exit \pliant stage left}
\surlyspeaks Sir, all is truth she says.\\
\facespeaks \vinphantom{Sir, all is truth she says.} Do not believe him, sir.\\
...
And all his tricks.
\direct*{Aside to \drugger}
\vinphantom{And all his tricks.} Make good what I say, Abel,\\
This cheater would have cozened thee of the widow.---\\
He owes this honest Drugger here, seven pound,\\
He has had on him, in two-pennyworths of tobacco.\\
\druggerspeaks Yes, sir. And he has damned himself three terms to pay me.\\
...
\direct*{\ananias enters stage right and knocks at the door}
\kastrilspeaks It is my humour: you are a pimp and a trig,\\
And an Amadis de Gaul, or a Don Quixote.\\
\druggerspeaks Or a knight of the curious coxcomb, do you see?\\
\direct*{\ananias tries the door and finding it open, comes in}
...
\direct*{Exit \kastril stage right. \subtle takes \ananias aside}
...
\facespeaks Who would have looked it should have been that rascal,\\
...
\subtlespeaks \vinphantom{No: 'twas within the walls.} Was it so? Cry you mercy.\\
...
\direct*{Exit \face, \subtle and \dol stage left}
\act
...
A plague of the moth, say I! Sure he has got\\
...
Or it may be, he has the fleas that run at tilt\\
...
\direct*{\lovewit knocks at the door}
...
\direct*{Enter \face stage left, dressed as Jeremy}
\neighthreespeaks That I will presently, sir, but fetch my tools---\\
\direct*{Exit \neighthree stage right}
\neighonespeaks Sir, best to knock again, afore you break it.\\
\direct*{\lovewit knocks}
\lovewitspeaks I will.\\
\direct*{\face opens the door and goes out}
\facespeaks \vinphantom{I will.} What mean you, sir?\\
\neighonespeaks
\neightwospeaks
\neighfourspeaks \direct*{Together} \vinphantom{I will. What mean you, sir?} O, here's Jeremy!\\
...
\direct*{Enter \neighthree stage right, with tools}
...
\direct*{Enter \surly and \mammon stage right}
\facespeaks \direct*{Aside} \vinphantom{Peace, and get hence, you changelings.} Surly come!\\
...
\direct*{Exit \mammon and \surly stage right}
\lovewitspeaks \vinphantom{We shall have your doors open.} What means this?\\
\facespeaks I cannot tell, sir.\\
\neighonespeaks \vinphantom{I cannot tell, sir.} These are two of the gallants\\
...
\direct*{Enter \kastril stage right}
\direct*{Aside}
...
\direct*{Enter \ananias and \tribulation}
\facespeaks \vinphantom{Here comes another.} Ananias too!\\
And his pastor!\\
\direct*{\tribulation knocks at the door}
\tribulationspeaks \vinphantom{And his pastor!} The doors are shut against us.\\
...
\direct*{Exit \ananias, \tribulation and \kastril stage right}
...
\dapperspeaks \direct*{Off stage left} \vinphantom{Would I could get him away.} Master captain! master doctor!\\
\lovewitspeaks Who's that?\\
\facespeaks \direct*{Aside} \vinphantom{Who's that?} Our clerk within, that I forgot! I know not, sir.\\
\dapperspeaks \direct*{Off stage left} For God's sake, when will her grace be at leisure?\\
\facespeaks \vinphantom{For God's sake, when will her grace be at leisure?} Ha!\\
Illusions, some spirit of the air---\\
\direct*{Aside}
\vinphantom{Illusions, some spirit of the air---} His gag is melted,\\
And now he sets out the throat.\\
\dapperspeaks \direct*{Off stage left} \vinphantom{And now he sets out the throat.} I am almost stifled---\\
...
\dapperspeaks \direct*{Off stage left} Mine aunt's grace does not use me well.\\
\subtlespeaks \direct*{Off stage left} \vinphantom{Mine aunt's grace does not use me well.} You fool,\\
...
\lovewitspeaks \vinphantom{What shall I do? I am catched.} Good neighbours,\\
I thank you all. You may depart.\\
\direct*{Exit \neighone, \neightwo and \neighthree stage right}
\vinphantom{I thank you all. You may depart.} ---Come, sir,\\
...
\direct*{\face and \lovewit go inside and exit stage left}
\scene

\direct*{Enter \subtle and \dapper stage left, \dapper blindfolded}
...
\direct*{Enter \face stage left, dressed as the Captain}
\vinphantom{So satisfy her grace.} Here comes the captain.\\
...
\direct*{Enter \dol, dressed as the Queen of Fairy}
...
\subtlespeaks \direct*{Aside} Ay, much! indeed.---Why do you not thank her grace?\\
\dapperspeaks I cannot speak for joy.\\
\subtlespeaks \vinphantom{I cannot speak for joy.} See, the kind wretch!\\
...
\dolspeaks \vinphantom{You must not look on it.} No: and kinsman,\\
...
\dapperspeaks \vinphantom{The gallant'st company, and the best games---}  Yes, sir.\\
\subtlespeaks Gleek and primero; and what you get, be true to us.\\
\dapperspeaks By this hand, I will.\\
\subtlespeaks \vinphantom{By this hand, I will.} You may bring us a thousand pound\\
...
\facespeaks \direct*{Off stage left} \vinphantom{Your fly will learn you all games.} Have you done there?\\
...
\direct*{Exit \dapper stage right. Enter \face stage left}
...
\direct*{\subtle and \dol kiss. Enter \face}
...
\direct*{Enter \drugger and a parson, stage right. \drugger knocks at
  the door. \face looks out of the window}
...
\direct*{\subtle goes to the door; he sends \drugger away and leads
  the parson off stage left; \drugger exits stage right}
...
\direct*{Enter \officerone, \officertwo, \mammon, \surly, \kastril,
  \ananias and \tribulation stage right; \officerone knocks loudly at the door}
...
\officeronespeaks \vinphantom{You are a precious fiend!} Open the door.\\
...
\direct*{\face ushers \subtle and \dol off stage left}
\scene

\direct*{Enter \lovewit, dressed as a Spaniard, and the parson stage
  left. \officerone knocks loudly at the door}
...
\officeronespeaks \vinphantom{Cheaters, bawds, conjurers.} Or we will break it open.\\
\lovewitspeaks What warrant have you?\\
\officeronespeaks \vinphantom{What warrant have you?h} Warrant enough, sir, doubt not,\\
...
\lovewitspeaks \vinphantom{Yes, two or three for failing.} Have but patience,\\
...
\direct*{\mammon, \surly, \kastril, \ananias, \tribulation, \officerone and
  \officertwo push their way inside}
...
\ananiasspeaks \vinphantom{Madam suppository. Doxy, my suster.} Locusts\\
Of the foul pit.\\
...
\lovewitspeaks \vinphantom{Of shame and of dishonour.} Good zeal, lie still\\
A little while.\\
...
\direct*{Exit \mammon, \ananias and \tribulation stage left}
...
\direct*{Exit \kastril stage left}
...
All in a twinkling!\\
\direct*{Enter \mammon stage left}
...
\direct*{Exit \mammon and \surly stage right. Enter \ananias and \tribulation stage left}
...
\ananiasspeaks \vinphantom{I shall confute you with a cudgel.} Sir!\\
\tribulationspeaks Be patient, Ananias.\\
\ananiasspeaks \vinphantom{Be patient, Ananias.} I am strong,\\
...
\direct*{Exit \ananias and \tribulation stage right. \drugger enters
  stage right and looks in through the open door}
\lovewitspeaks Another too?\\
\druggerspeaks \vinphantom{Another too?} Not I, sir, I am no brother.\\
\direct*{\lovewit beats \drugger}
\lovewitspeaks Away, you Harry Nicholas! do you talk?\\
\direct*{Exit \drugger stage right}
\facespeaks No, this was Abel Drugger.
\direct*{To the parson} \vinphantom{No, this was Abel Drugger.} Good sir, go,\\
And satisfy him; tell him all is done:\\
He stayed too long a-washing of his face.\\
The doctor, he shall hear of him at Chester;\\
And of the captain, tell him, at Yarmouth, or\\
Some good port town else, lying for a wind.\\
\direct*{Exit parson stage right}
If you get off the angry child, now, sir---\\
\direct*{Enter \kastril and \pliant stage left}
...
\direct*{Exit \kastril and \pliant stage left}
...
\vinphantom{Of his own candour.} ---Therefore, gentlemen,\\
...
\direct*{To the audience}
\vinphantom{Speak for thy self, knave. So I will, sir.} Gentlemen,\\
...
\direct*{Exit \face and \lovewit stage left}
