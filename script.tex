...
\direct*{Enter \subtle, dressed as the Alchemist}
Good morrow, father.\\
...
\direct*{DOL APPEARS AT THE DOOR}
...
\direct*{EXIT.}
\mammonspeaks \direct*{STOPPING HIM} \vinphantom{Would she, sir! Follow me.} Stay, Lungs.\\
...
\subtlespeaks \direct*{WITHIN} \vinphantom{Sir, to be cured.} Why, rascal!\\
...
Or so?\\
\subtlespeaks \direct*{WITHIN} \vinphantom{Or so?} Ulen!\\
...
\vinphantom{Sir,} if you please to quit us, now; and come\\
